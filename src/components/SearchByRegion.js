...
const SearchByRegion = (setSearchRegion , setSearchArea, searchRegion ) => {
    ...
    console.log(area)
    let filterArea = area.filter(area => area.comunas === searchRegion )
    ...
    return (
        <div className="container">
            <select class="form-select" aria-label="Default select example"
                ...
                {searchRegion !== "" ? filterArea.map((reg ) => {
                    return (
                    <option key={reg.id}>
                        {reg.comunas}
                    </option>
